...
from dagster_src.contrib.google import get_credentials
from dagster_src.resources.data_repo.api_configuration import RefreshingAccessTokenConfig
...
class NoopDataRepoClient:
    ...
    def add_snapshot_policy_member(self, id: str, policy_name: str,
                                   policy_member: PolicyMemberRequest) -> PolicyResponse:
